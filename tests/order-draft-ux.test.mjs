...
assert.match(index,/module-loader\.js\?v=20260902-(?:draft-ux|freight-money|ops-ux|ops-data|freight-popup-history)-v1|20260902-simulator-(?:architecture-v2|hotfix-v3)/);
