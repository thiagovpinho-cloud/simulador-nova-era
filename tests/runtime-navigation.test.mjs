...
assert.ok(/assets\/app-shell\.js\?v=(?:20260828-edit-actions-v\d+|20260829-mobile-v\d+|20260902-freight-center-v\d+)/.test(index),'Shell deve publicar proteção contra rerender, navegação e central de frete');
