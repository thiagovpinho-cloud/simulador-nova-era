...
assert.match(index,/module-loader\.js\?v=20260902-(?:freight-center|draft-ux|freight-money|ops-ux|ops-data|freight-popup-history)-v[12]|20260902-simulator-(?:architecture-v2|hotfix-v3)/);
