...
const specs={
  pedidos:{
    ...
    body:/Registro oficial do pedido|Nenhum pedido encontrado|pedido\(s\)/,
    required:['products.js','orders.js'],
  ...
  inventory:{
    selector:'.finv-page',
    title:'Estoque',
    body:/Estoque|produto/i,
    required:['inventory.js'],
    forbidden:['pcp.js','production.js','purchases.js','logistics.js','intelligence.js','intelligence-core.js']
  },
  purchases:{
    selector:'.fpur-page',
    title:'Compras',
    body:/Compras|reposição|fornecedor/i,
    required:['purchases.js'],
    forbidden:['pcp.js','production.js','logistics.js','intelligence.js','intelligence-core.js']
  },
  logistica:{
    selector:'.fl-page',
    title:'Logística',
    body:/Logística|frete|transport/i,
    required:['logistics.js'],
    forbidden:['pcp.js','production.js','purchases.js','intelligence.js','intelligence-core.js']
  },
  expedicao:{
    selector:'.fexp-page',
    title:'Expedição',
    body:/Expedição|despacho|entrega/i,
    required:['expedition.js'],
    forbidden:['pcp.js','production.js','purchases.js','logistics.js','intelligence.js','intelligence-core.js']
  }
};
...
await page.addInitScript(()=>{
  ...
  localStorage.setItem('focado-operacoes-v2',JSON.stringify({
    version:3,
    orders:[{
      id:'op_e2e_1',number:'PED-E2E-0001',status:'COMERCIAL',createdAt:Date.now(),
      client:'CLIENTE E2E',cnpj:'12345678000195',representative:'',brand:'Nova Era',orderDate:new Date().toISOString().slice(0,10),
      items:[{id:'i1',productId:'',code:'',name:'Item E2E',qty:1,price:10,reservedQty:0}],
      commercial:{completedAt:null,completedBy:null},pcp:{},logistics:{},events:[]
    }],
...
try{
  ...
  const result=await page.evaluate(async routeName=>{
    try{
      await window.FocadoShell.navigate(routeName);
