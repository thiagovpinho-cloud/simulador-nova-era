(function(){
  ...
  const defs={
    ...
    'delivery-finalize-bridge':{js:'delivery-finalize-bridge.js'},
    'freight-quote-ui':{js:'freight-quote-ui.js'},
    ...
    inputs:{css:'inputs.css',js:'inputs.js',deps:['inventory','simulator-master-data']},
    purchases:{css:'purchases.css',js:'purchases.js'},
    expedicao:{css:'expedition.css',js:'expedition.js'},
    logistica:{css:'logistics.css',js:'logistics.js',deps:['delivery-finalize-bridge']},
  ...
  const contracts={
    ...
    'delivery-finalize-bridge':()=>window.FocadoDeliveryFinalizeBridge?.active===true,
    'freight-quote-ui':()=>window.FocadoFreightQuoteUI?.active===true,
    ...
    inputs:()=>typeof window.FocadoInputs?.render==='function'&&typeof window.FocadoInventory?.render==='function',
  ...
  function loadOrderComplements(){optional('order-drafts');optional('pcp-commercial-alerts');optional('freight-quote-ui');}
  async function ensure(name){
    ...
    const p=(async()=>{
      ...
      if(existing&&existing()){
        ...
        if(name==='logistica')optional('freight-quote-ui');
        return true;
      }
