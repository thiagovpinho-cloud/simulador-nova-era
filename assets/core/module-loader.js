(function(){
  ...
  const defs={
    ...
    'order-logistics':{js:'order-logistics.js',deps:['logistics-reference']},
    pedidos:{css:'orders.css',js:'orders.js',deps:['produtos','order-drafts','order-logistics']},
  ...
  const contracts={
    ...
    'order-logistics':()=>typeof window.FocadoOrderLogistics?.render==='function',
