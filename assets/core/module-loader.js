(function(){
  ...
  const defs={
    ...
    'logistics-flow':{css:'logistics-flow.css',js:'logistics-flow.js',deps:['logistics-engine']},
    simulador:{css:'simulator.css',js:'simulator.js',deps:['simulator-master-data','produtos','logistics-flow']},
    ...
    'deferred-intelligence':{js:'../core/deferred-intelligence.js'},
    pendencias:{css:'pendencias.css',js:'pendencias.js'},
    'freight-requests':{css:'freight-requests.css',js:'freight-requests.js',deps:['logistics-flow']},
    'cotacoes-frete':{alias:'freight-requests'},
    'cotacoes-frete-logistica':{alias:'freight-requests'},
    'order-drafts':{js:'order-drafts.js'},
    pedidos:{css:'orders.css',js:'orders.js',deps:['produtos','order-drafts','logistics-flow']},
    pcp:{css:'pcp.css',js:'pcp.js',deps:['produtos','production','deferred-intelligence']},
    ...
    purchases:{css:'purchases.css',js:'purchases.js',deps:['deferred-intelligence']},
    expedicao:{css:'expedition.css',js:'expedition.js'},
    logistica:{css:'logistics.css',js:'logistics.js',deps:['deferred-intelligence']},
  ...
  const contracts={
    ...
    'logistics-flow':()=>typeof window.FocadoLogisticsFlow?.refresh==='function',
    ...
    'order-drafts':()=>typeof window.FocadoOrderDrafts?.render==='function',
