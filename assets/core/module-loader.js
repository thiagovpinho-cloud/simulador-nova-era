(function(){
  ...
  const defs={
    ...
    simulador:{css:'simulator.css',js:'simulator.js',deps:['simulator-master-data','produtos']},
  ...
  const contracts={
    ...
    produtos:()=>typeof window.FocadoProducts?.render==='function'&&typeof window.FocadoProducts?.calculateLoad==='function',
