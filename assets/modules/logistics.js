(function(){
  ...
  function renderDetail(o,ops){
    ...
    content().innerHTML='<div class="fl-page">'+
      '<div class="fl-head"><div><button class="fl-btn primary" id="flBack">← Logística</button><h1>Logística · '+esc(o.number)+'</h1><p>'+esc(o.client||'')+'</p></div><span class="fl-chip '+(pre?'warn':'ready')+'">'+(pre?'Pedido ainda no PCP':'Pedido liberado')+'</span></div>'+
